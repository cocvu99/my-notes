...
### Inheritance: How does it promote code reuse? Explain different types of inheritance (e.g., single, multiple – if supported by the language).
...
### Polymorphism: What does "many forms" mean in OOP? Explain method overloading and method overriding with examples.
...
### Abstraction: How does it simplify complex systems by focusing on essential details? Discuss abstract classes and interfaces.
...
## Design Patterns (General Knowledge): (Các mẫu thiết kế – kiến thức chung)
